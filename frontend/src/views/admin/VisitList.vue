<template>
  <div>
    ...
    <div class="container">
      ...
      <div class="card">
        <div class="card-header">All visits</div>
        <div class="card-body">
          <form ref="form">
            <table class="table table-hover">
              ...
              <tbody>
                <tr v-for="visit in visits" v-bind:key="visit.id">
                  ...
                  <td>
                    <i
                      class="oi oi-check visit-list__oi-check"
                      v-if="visit.isActive"
                    >
                    </i>
                  </td>
                  ...
                  <td class="visit-list__edit">
                    <router-link
                      :to="{ name: 'editVisit', params: { visitId: visit.id } }"
                    >
                  ...
                  <td class="visit-list__delete">
                    <i class="oi oi-trash" v-on:click="deleteVisit(visit.id)">
                    </i>
                  </td>
                </tr>
              </tbody>
...
export default {
  ...
  methods: {
    deleteVisit(visitId) {
      if (
        window.confirm(
          "Do you really want to delete a visit with ID: " + visitId + "?"
        )
      ) {
