    ...
    <div class="container">
      <div class="card">
        <div class="card-header">
          {{ "Edit visit with ID: " + this.$route.params.visitId }}
        </div>
        <div class="card-body">
          <div
          ...
          >
            ...
            <div class="form-check">
              <input
                ...
                v-model="newIsActive"
              />
              <label class="form-check-label" for="changeIsActive">
                Active
              </label>
            </div>
            <div class="form-check">
              <input
                ...
                v-model="newIsBooked"
              />
              <label class="form-check-label" for="changeIsBooked">
                Booked
              </label>
            </div>
...
export default {
  ...
  mounted() {
    ...
    const visitApi = fetch(
      "/dentalclinic/api/visits/get/" + this.$route.params.visitId
    ).then(response => {
      return response.json();
    });
