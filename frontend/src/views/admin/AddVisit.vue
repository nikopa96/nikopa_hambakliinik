    ...
    <div class="container">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form class="needs-validation" @submit.prevent="submit" v-if="procedures && doctors">
            <div class="form-group">
              <label for="addDoctor">Doctor:</label>
              <select class="custom-select" name="doctor" v-validate="'required'"
                      v-bind:class="{ 'is-invalid': errors.has('doctor') }" id="addDoctor" v-model="newDoctor">
            ...
            <div class="form-group">
              ...
              <select class="custom-select" name="procedure" v-validate="'required'"
                      v-bind:class="{ 'is-invalid': errors.has('procedure') }" id="addProcedure" v-model="newProcedure">
                <option v-for="procedure in procedures" v-bind:key="procedure.id" v-bind:value="procedure.id">
                  {{ procedure.name }}
                </option>
              </select>
              <div class="invalid-feedback">{{ errors.first('procedure') }}</div>
            </div>
            <div class="form-group">
